...
Lux Core has an internal benchmarking framework, with benchmarks
for cryptographic algorithms such as SHA1, SHA256, SHA512 and RIPEMD160. As well as the rolling bloom filter.

After compiling lux-core, the benchmarks can be run with:
`src/bench/bench_lux`
...
Trig,67108864,0.000004.0.0997003,0.000000015448112,0.000000015188842
```
